      ...
      <Box width="40%">
        <Box
          ...
          <FormField
            ...
            label="State Residence (if you don't know or you'd rather not to say, you can this leave blank)"
            registerFn={register}
            list={US_STATES}
          ...
          <FormField
            ...
            label="State Registered (if you don't know or you'd rather not to say, you can this leave blank)"
            registerFn={register}
            list={US_STATES}
          ...
          <FormField
            ...
            label="Registered To Vote (if you don't know or you'd rather not to say, you can this leave blank)"
            registerFn={register}
            list={VOTER_STATUS}
          ...
          <FormField
            ...
            label="Political Leaning (if you don't know or you'd rather not to say, you can this leave blank)"
            registerFn={register}
